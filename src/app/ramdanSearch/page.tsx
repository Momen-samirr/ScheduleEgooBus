...
const weeks = [
  {
    id: "https://script.google.com/macros/s/AKfycbzq8dZ-mmVHoAhoSQAKX3E41DYq7EaCRLIBukcDEEECVU-qoMKCIKF3HLiAKSDRzoBi/exec",
  ...
  return (
    <div className="relative min-h-screen flex flex-col gap-10 lg:flex-row items-center lg:justify-between lg:gap-5 p-6 transition-colors">
      ...
      <motion.div
        ...
        className="w-full flex justify-center max-w-lg relative z-10"
      >
        <Card className="rounded-3xl  mx-auto w-full shadow-lg border border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-gray-900/70 backdrop-blur-xl transition-colors">
